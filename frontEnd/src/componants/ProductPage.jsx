...
export default function ProductPage() {
    ...
    return (
        <div className='bg-slate-50 border-t border-slate-200 pb-[200px] md:pb-0'>
            <div className='container h-[80vh]'>
                {(product) ?
                    <div className='flex flex-wrap items-center h-5/6'>
                        <div className="w-[100%] md:w-[50%]">
                            <img className="p-6 md:p-1 w-[300px] md:w-auto mx-auto" src={product.images[0].path} alt="image" />
                        </div>
